...
print("\n" + "="*60)
print("ENERGY CONSUMPTION PREDICTION WITH PERIODIC RESET")
...
df_res.to_csv('../results/energy_results.csv', index=False)

plt.figure(figsize=(6,5))
sns.boxplot(data=df_res[['mse_base', 'mse_prop']])
plt.xticks([0,1], ['Baseline', 'Proposed'])
plt.ylabel('MSE')
plt.title('Energy Prediction MSE Comparison')
plt.savefig('../results/boxplot_energy.png', dpi=300)
plt.show()